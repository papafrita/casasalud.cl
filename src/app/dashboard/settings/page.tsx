    ...
    return (
        <div className="space-y-6 max-w-5xl">
            ...
            <div className="flex gap-2 mb-6 border-b border-gray-100 overflow-x-auto pb-1 custom-scrollbar">
                <button className="px-4 py-2 text-sm font-semibold text-gray-900 border-b-2 border-gray-900 whitespace-nowrap">Perfil profesional</button>
                <button className="px-4 py-2 text-sm font-medium text-gray-500 hover:text-gray-900 whitespace-nowrap">Cuenta</button>
                <button className="px-4 py-2 text-sm font-medium text-gray-500 hover:text-gray-900 whitespace-nowrap">Agendamiento</button>
                <button className="px-4 py-2 text-sm font-medium text-gray-500 hover:text-gray-900 whitespace-nowrap">Analytics</button>
                <button className="px-4 py-2 text-sm font-medium text-gray-500 hover:text-gray-900 whitespace-nowrap">Ajuste de búsqueda</button>
            </div>
