        ...
        <div className="space-y-6 max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                {connections.map((conn) => (
                    <div key={conn.id} className="bg-white rounded-2xl border border-gray-200 shadow-sm flex flex-col h-full overflow-hidden">
                        ...
                        <div className="p-4 border-t border-gray-100 bg-gray-50/50">
                            <button
                                onClick={conn.onClick}
                                className="px-5 py-2 text-sm font-medium border border-gray-200 rounded-xl text-gray-700 bg-white hover:bg-gray-50 shadow-sm transition-colors w-full text-left"
                            >
                                {conn.action}
                            </button>
                        </div>
